...
resource "allquiet_status_page" "privacy_status_page" {
  slug                           = "privacy-status-page-test"
  display_name                   = "Privacy Status Page"
  public_title                   = "Privacy Status Page"
  public_description             = "Status page with privacy controls"
  history_in_days                = 30
  disable_public_subscription    = false
  public_display_live_state_only = true
  public_hide_incident_details   = true
  public_hide_maintenances       = true
