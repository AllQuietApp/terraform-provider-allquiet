...
- `integrations` (Attributes List) Linked integrations for this service. Each entry links an integration to the service with optional severity filter. (see [below for nested schema](#nestedatt--integrations))
...
- `integration_id` (String) The integration id to link
- `severities` (List of String) Severities that this link applies to. Possible values are: Critical, Warning, Minor

Read-Only:

- `id` (String) Id of the linked integration entry (generated by the API when not set)
