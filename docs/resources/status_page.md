...
- `public_display_name` (String) The public display name of the service group. When omitted or empty, services in this group are shown individually on the status page (no group header). Set a title to display a collapsible group, matching the UI 'Service Group Public Title'.
